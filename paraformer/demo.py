...
model = AutoModel(
    model="/media/fl01/data01/WorkSpace/FunASR/model/paraformer_models/speech_paraformer-large-vad-punc_asr_nat-zh-cn-16k-common-vocab8404-pytorch",
    vad_model="/media/fl01/data01/WorkSpace/FunASR/model/vad_models/speech_fsmn_vad_zh-cn-16k-common-pytorch",
    vad_kwargs={"max_single_segment_time": 60000},
    punc_model="/media/fl01/data01/WorkSpace/FunASR/model/punc_models/punc_ct-transformer_zh-cn-common-vocab272727-pytorch",
    # spk_model="iic/speech_campplus_sv_zh-cn_16k-common",
)

res = model.generate(
    input="/home/fl01/下载/audio.wav",
    cache={},
)
